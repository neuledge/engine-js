import { ArrayType, StateFieldType, UnionType } from '@/field.js';
...
import { SchemaNullableKeys, SchemaRequiredKeys } from '@/schema/index.js';
...
export type EntityCreateData<S extends State> = {
  [K in SchemaRequiredKeys<S['schema']>]: EntityFieldData<
    S['schema'][K]['type']
  >;
} & {
  [K in SchemaNullableKeys<S['schema']>]?: EntityFieldData<
    S['schema'][K]['type']
  > | null;
};
